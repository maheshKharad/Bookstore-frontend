...
function Banner() {
  return (
    <>
      <div className="max-w-screen-2x1 container ms-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-36">
          <div className="space-y-8">
            ...
            <p className="text-sm md:text-x1">
              ...
              totam. Tempora amet amet expedita, quae corrupti totam sed pariatur
