...
function Navbar() {
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1">{nanItems}</ul>
  </div>
  <div className="hidden md:block ">
  <label className=" px-3 py-2 border rounded-md flex items-center gap-2">
  <input
   type="text" 
   className="grow outline-none dark:bg-slate-900 dark-white " 
   placeholder="Search" 
   />
  <svg
   xmlns="http://www.w3.org/2000/svg"
  ...
  <div className="">
    <a 
    className="bg-black text-white p-3 py-2rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
